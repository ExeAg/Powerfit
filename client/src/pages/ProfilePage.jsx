...
function ProfilePage() {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: `url(/images/imagenParaPagina.jpg)` }} // Imagen de fondo
    >
      <div className="flex flex-row w-full">
        ...
        <div className="container mx-auto">
            <Link to="/modificar">
              <button className="bg-black bg-opacity-80 text-green-800 px-48 py-2 my-5 border-2 border-green-800 hover:bg-white text-xl">Datos alumno/cliente</button>
            </Link>
          </div>

          <div className="container mx-auto">
            <Link to="/add-task">
              <button className="bg-black bg-opacity-80 text-green-800 px-48 py-2 my-5 border-2 border-green-800 hover:bg-white text-xl">Agregar rutina/dieta</button>
            </Link>
          </div>
          ...
          <div className="container mx-auto">
            <Link to="/tasks">
              <button className="bg-black bg-opacity-80 text-green-800 px-28 py-2 my-5 border-2 border-green-800 hover:bg-white text-xl">Ver rutinas/dietas enviadas</button>
            </Link>
          </div>
